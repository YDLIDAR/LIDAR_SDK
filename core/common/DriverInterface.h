...
public:
    enum LIDAR_MODLES {
        LIDAR     = 300,/**< LiDAR Model. */
    };

    enum LIDAR_RATE {
        LIDAR_RATE_4K = 0,/**< 4K sample rate code */
        LIDAR_RATE_8K = 1,/**< 8K sample rate code */
        LIDAR_RATE_9K = 2,/**< 9K sample rate code */
        LIDAR_RATE_10K = 3,/**< 10K sample rate code */
    };
...
public:
     ...
     * @see function ::lidarDriver::disconnect ()
     */
